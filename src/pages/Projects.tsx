...
const ProjectsPage = () => {
  const projects = [
    {
      title: "1 – Studi Kasus AI di Bidang Tertentu",
      ...
      liveUrl: "https://drive.google.com/drive/folders/1nY6mX4RLxkdmlRRukSIGJlFbJIjn-JqS?usp=sharing", // Tautan Google Drive yang diperbarui
    },
    {
      title: "2 – Konten Carousel Instagram",
    ...
    {
      title: "3 – Branding Visual dan Konten Carousel",
    ...
    {
      title: "4 – Pembuatan Komik dengan AI",
