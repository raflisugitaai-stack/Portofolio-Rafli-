...
import React from "react"; // Menghapus useState, useEffect, useRef
import Layout from "@/components/layout/Layout";
import { Button } from "@/components/ui/button";
import { Link } from "react-router-dom";
// Menghapus import CameraIcon, Trash2
// Menghapus import showSuccess, showError

const HomePage = () => {
  // Menghapus state profileImage dan fungsi-fungsi terkait
  const staticProfileImage = "/placeholder.svg"; // Menggunakan gambar placeholder statis
    ...
    <Layout>
      <div className="flex flex-col items-center justify-center text-center py-20 px-4">
        <div className="relative w-40 h-40 mb-8">
          ...
          />
          {/* Menghapus elemen input file dan tombol unggah/hapus */}
        </div>
